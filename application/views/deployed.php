...
<div class="container-fluid">
  ...
  <div class="row page-titles">
    <div class="col-md-6 col-8 align-self-center">
      <h3 class="text-themecolor mb-0 mt-0">Deployed Asset</h3>
      <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Deployed Asset</h4>
            ...
            <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="<?php echo base_url('data/broken/'.$row->id_master);?>"><button type="button" class="btn btn-warning btn-sm"><em class="fas fa-cogs" data-toggle="tooltip" data-placement="bottom" title="Broken"></em></button></a>
                  <!-- <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#detailAsset<?php echo $row->id_master;?>"><i class="fas fa-list-ul"></i></button></td> -->
                </tr>
                <?php }?>
              </tbody>
            </table>
